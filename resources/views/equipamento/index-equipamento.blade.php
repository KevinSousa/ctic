                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title text-center" id="myModalLabel" style="margin-left: 8em;">Excluir equipamento?</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              </div>
                                <input type="hidden" name="category_id" id="cat_id" value="">       
                                <div class="modal-footer">
                                    <div style="margin-right: 10em;">
                                        <a href="#" data-dismiss="modal" count="{{$count}}" url="{{$equipamentos->equip_tombamento }}" class="btn btn-success deletar-sucesso">Sim</a>
