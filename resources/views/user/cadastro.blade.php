...
<body><div id="index">
	...
	<div   class="form-row">
		<div class="form-group col-md-6">
			...
			<input class="form-control" type="text" name="user_cpf" value="" required="" maxlength="14" id="user_cpf">
		</div>

		<div class="form-group col-md-6">
			<label for="">Número da Matricula ou Siape *</label>

			<input class="form-control " type="text" name="user_siap_matricula" value="" required="" maxlength="14">
	...
	<div class="form-row">
		<div class="form-group col-md-6">
			...
			<input class="form-control" type="email" name="user_email" value="" required="">
		</div>
		<div class="form-group col-md-6">
